...
RUN set -x \
	...
	&& (cd "$GOPATH/src/github.com/docker/notary" && git checkout -q "$NOTARY_COMMIT") \
        && (cd "$GOPATH/src/github.com/docker/notary/Godeps/_workspace/src/github.com/dvsekhvalnov" && rm -rf jose2go && git clone https://github.com/dvsekhvalnov/jose2go.git ) \
